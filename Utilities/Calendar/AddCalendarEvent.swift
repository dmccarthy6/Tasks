        ...
        calendarManager.presentCalendarModalToAddEvent(event: calendarEvent) { (result) in
            ...
            case .failure(let error):
                ...
                case .calendarAccessDeniedOrRestricted:
                    Alert.showSettingsBasicAlert(self.viewController, title: "Calendar Access Denied", message: CalendarAlertsMessage.restricted.rawValue)
                    
                case .eventAlreadyExistsInCalendar:
                    Alerts.showNormalAlert(self.viewController, title: "", message: CalendarAlertsMessage.eventExists.rawValue)
                    
                case .eventNotAddedToCalendar:
                    Alerts.showNormalAlert(self.viewController, title: "", message: CalendarAlertsMessage.eventNotAdded.rawValue)
                }
            }
        }
    }
