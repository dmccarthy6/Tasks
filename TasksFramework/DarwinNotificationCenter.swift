...
extension DarwinNotification.Name {
    ...
    /// The relavent DarwinNotification name to observe when themanaged object context has been saved in  an external process.
    ...
    private static var extensionDidSaveManagedObjectContext: DarwinNotification.Name {
        return DarwinNotification.Name(savedFromApp)
    }
    
    private static var appDidSaveManagedObjectContext: DarwinNotification.Name {
        return DarwinNotification.Name(savedFromExtension)
    }
    
    private static var savedFromApp: String {
        return "Save From App"
    }
    private static var savedFromExtension: String {
        return "Saved from extension"
    }
}
