...
![Tasks List Added](Images/ListAdded_Dark.png) ![Tasks With Items Showing](Images/ItemsShowing_Dark.png)![Tasks Adding To Calendar](Images/AddToCalendar_Dark.png) ![Tasks Reminders Added](Images/RemondersAddedGitHub_Dark.png) 
